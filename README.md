...
- **项目管理**：Plan制定章程→Do执行监控→Check阶段评审→Act总结归档
- **问题解决**：Plan定义对策→Do实施改进→Check验证根因→Act标准化预防
- **流程改进**：Plan识别机会→Do实施新流程→Check评估绩效→Act固化优化

详见 [理论基础](.trae/skills/pdca/references/theory.md)。
