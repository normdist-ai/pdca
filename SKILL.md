...
2. **创建问题文件夹**：创建 `issue-yyyyMMdd-HHmmss/` 文件夹（使用实际时间）
3. **创建问题概述**：在问题文件夹中创建 `README.md`，记录问题基本信息
4. **创建PDCA过程文件**：在相应阶段文件夹中创建过程文件
5. **更新问题索引**：在 `issue-list.md` 中添加或更新问题记录
6. **更新问题状态**：随着PDCA循环进展，及时更新问题状态
